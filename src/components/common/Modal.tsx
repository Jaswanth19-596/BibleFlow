...
export default function Modal({ open, onClose, title, children, size = 'md' }: ModalProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[1000] flex items-end justify-center sm:items-center">
      ...
      />
      <div
        className={`relative bg-white dark:bg-gray-800 rounded-t-2xl sm:rounded-xl shadow-2xl w-full ${sizes[size]} max-h-[calc(100dvh-0.75rem)] sm:mx-4 sm:max-h-[90vh] overflow-y-auto`}
      >
