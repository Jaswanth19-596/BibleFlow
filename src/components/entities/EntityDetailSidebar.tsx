...
export default function EntityDetailSidebar({ entity, onClose }: EntityDetailSidebarProps) {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 max-h-[calc(100dvh-0.75rem)] w-full rounded-t-2xl bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-xl z-40 flex flex-col animate-slide-in-right sm:inset-y-0 sm:left-auto sm:max-h-none sm:w-96 sm:rounded-none sm:border-l sm:border-t-0">
      {/* Header */}
      ...
      {/* Content */}
      <div className="flex-1 overflow-y-auto overscroll-contain p-4 pb-[max(1rem,env(safe-area-inset-bottom))] space-y-5">
        {/* Relationships */}
